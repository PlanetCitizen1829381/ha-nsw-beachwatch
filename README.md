...
Each beach provides 4 sensor states;<br />
_Attributes are located in the overflow menu of the sensor and in Developer Tools > State_
...
![Extended Advice Example](images/NSWBW_Advice_Ext_Example.png)
